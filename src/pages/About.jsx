  ...
  const journey = [
    {
      ...
      description:
        "4th Year BS.c in Computer Science & Engineering, building strong fundamentals in DSA and computer science principles.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Currently i'm not starting but i will be start my channel very soon.",
    },
  ];
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className={`text-lg leading-relaxed ${textPrimary} mb-4`}>
            ...
            , A passionate Computer Engineering student focused on building scalable, 
            user-centric applications. Began my development journey with core Data 
            Structures and Algorithms, forming a solid foundation in programming and problem solving.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className={textPrimary}>
                  Complete Full stack mastery with deployment experience
                </p>
              </div>
            </div>
          </div>
