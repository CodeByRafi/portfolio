...
const Home = () => {
  ...
  const roles = [
    ...
    },
    {
      icon: FaDatabase,
      title: "Data Analyst",
      desc: "Python. SQL and Data Visualization",
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-28 pb-12 sm:pb-16 md:pb-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16 items-start pt-14">
          <div className="flex flex-col justify-center text-center md:text-left">
            ...
            >
              Full Stack Developer | AI/ML & Data Analysis
            </p>
            ...
            >
              ...
              <span className="font-semibold">user-friendly web applications while</span>. Beyond coding,
              exploring AI/ML and Data Analysis to create smarter solutions{" "}
              <span className="font-semibold">
                I enjoy turning ideas into real projects, analyzing data for insights
              </span>
              and continuously improving <span className="font-semibold">my skills through practical problem-solving </span>development challenges.{" "}
